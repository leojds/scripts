...
local ClassesContainer = {
	...
	Physical = {
		...
		Archer = {
			...
			{ 162, "Wizard" },	-- YulSagittarius
			{ 163, "Wizard" },	-- YulMoonlightSentinel
			{ 164, "Wizard" },	-- YulGhostSentinel
			{ 165, "Wizard" },	-- YulTrickster
