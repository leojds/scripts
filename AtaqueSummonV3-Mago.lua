...
TSummon = "m"; -- Changes pet type to summon, (m: magic summons, t: tanking summons, w: warrior summons)
...
function SummonBuffs()
	...
	if (me:GetClass() == 177) then
		UseSkillRaw(11348, false, false); -- Servitor Death Whisper
	end;
	if (me:GetClass() == 178) then
		UseSkillRaw(11349, false, false); -- Greater Servitor Might
	end;
	if (me:GetClass() == 176) then
		UseSkillRaw(11347, false, false); -- Greater Servitor Haste
	end;
end;
...
function SummonerRage()
	...
	if (me:GetClass() == 176) then
		UseSkillRaw(11350, false, false); -- Arcana Rage
		Sleep(800);
	end;
end;
...
function SummonerBuffs()
	if (GetMe():GotBuff(11288) == false) then
		Sleep(500);
		UseSkillRaw(11288, false, false); -- Ultimate Servitor Share
		Sleep(500);
		SummonBuffs();
		Sleep(1000);
	end;
	if (GetMe():GotBuff(11270) == false) then
		Sleep(500);
		UseSkillRaw(11270, false, false); -- Ultimate Servitor Share
		Sleep(500);
		SummonBuffs();
		Sleep(1000);
	end;
...
function SummonerAtkM()
	...
	Sleep(500);
	UseSkillRaw(11271, false, false); -- Mark Retriever
	Sleep(500);
	--UseSkillRaw(11263, false, false); -- Invoke
	--Sleep(500);
	UseSkillRaw(11276, false, false); -- Dimensional Binding
end;
